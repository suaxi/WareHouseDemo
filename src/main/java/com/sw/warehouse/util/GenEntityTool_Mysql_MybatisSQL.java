...
public class GenEntityTool_Mysql_MybatisSQL {
    public static void main(String[] args) {
        // MYSQL 数据库连接驱动信息
        String databaseName = "warehouse";// mysql数据库名称
        String user = "root"; // 数据库连接用户名
        String password = "root"; // 数据库连接密码
        String tableName = "whuploadinfo"; // 要生成实体类的数据库表名（数据库中表名称）
        String entityName = "Whuploadinfo";// 要生成实体类的表名 【Java类名】
        String driverClassName = "com.mysql.jdbc.Driver";
        String url = "jdbc:mysql://localhost:3306/" + databaseName + "?characterEncoding=utf8&useUnicode=true";// //
