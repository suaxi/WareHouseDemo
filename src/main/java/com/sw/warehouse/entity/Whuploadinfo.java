...
@Entity(name="whuploadinfo") //表名
@EntityListeners(AuditingEntityListener.class)
public class Whuploadinfo {
	@Id //主键
	...
	public String toString(){
		return " Whuploadinfo [id=" + id+ " , result=" + result+ " , msg=" + msg+ " , picurl=" + picurl+ " , filepath=" + filepath+ " , createtime=" + createtime+"]";
	}
